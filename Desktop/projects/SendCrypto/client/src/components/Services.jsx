...
const Services = () => {
  return (
    <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services'>
      ...
      <div className='flex-1 flex flex-col justify-start items-center mx-3'>
        <ServiceCard
          color="bg-[#2952E3]"
          title="Security Guranteed"
          icon={<BsShieldFillCheck fontSize={21} className="text-white"/>}
          subtitle="security is guranteed. We always maintain privacy and maintain the quality of the products"
        />
        <ServiceCard
          color="bg-[#9845F8]"
